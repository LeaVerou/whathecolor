...
/**
 * A single color-guessing round: a target color and the sequence of valid guesses made against it.
...
export default class Round {
	 ...
	 * @param {CssColor[]} attempts - Valid guesses in the order they were made
	 */
